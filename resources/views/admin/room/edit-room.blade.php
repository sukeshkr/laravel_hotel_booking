        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form action="{{route('room.update')}}" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        @error('room_no')
                        <div class="text-danger text-center">{{$message}}</div>
                        @enderror
                        @error('hotel_id')
                        <div class="text-danger text-center">please select hotel</div>
                        @enderror
                        @error('price')
                        <div class="text-danger text-center">{{$message}}</div>
                        @enderror
                        ...
                        <input type="hidden" name="id" value="{{$roomData->id}}">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="number" name="room_no" value="{{old('room_no',$roomData->room_no)}}" class="form-control @error('room_no') is-invalid @enderror">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select class="form-control @error('hotel_id') is-invalid @enderror" name='hotel_id'>
                                        ...
                                        <option value="{{$data->id}}" @selected(old('hotel_id',$roomData->hotel_id)==$data->id)>{{$data->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>

                            <div class="item form-group">{{$data->price}}
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">price<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="number" name="price" value="{{old('price',$roomData->price)}}" id="first-name" class="form-control @error('price') is-invalid @enderror">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <img width="120" height="70" src="{{asset('room/'.$roomData->file)}}" alt="blog">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <ul>
                                        @foreach ($roomData->specifications as $specifics)
                                            <li>{{$specifics->specification}}</li>
                                        @endforeach
                                    </ul>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    ...
                                    <a class="btn btn-primary" href="{{route('room')}}">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
