        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="{{route('post.login')}}" method="POST">
                @csrf
                <h1><i class="fa fa-cog fa-spin fa-1x fa-fw" aria-hidden="true"></i>
                    <span class="sr-only">Saving. Hang tight!</span> Booking Admin</h1>
                @if (session('sucess'))
              ...
              <div>
                <button name="submit" value="submit" type="submit" class="form-control btn btn-outline-secondary">Log In</button>
