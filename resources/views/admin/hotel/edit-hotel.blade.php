        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form action="{{route('hotel.update')}}" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        @error('name')
                        ...
                        <div id="cropped_imagename"></div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="name" value="{{old('name',$data->name)}}"  class="form-control @error('name') is-invalid @enderror">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="location" value="{{old('location',$data->location)}}" id="first-name" class="form-control @error('location') is-invalid @enderror">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <img width="120" height="70" src="{{asset('hotel/'.$data->file_name)}}" alt="blog">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    ...
                                    <a class="btn btn-primary" href="{{route('hotel.list')}}">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
